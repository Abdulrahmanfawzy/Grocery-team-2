  ...
  return (
    <div className="mt-10 sm:mt-16">
      ...
      <Carousel className="relative w-full px-2 sm:px-10 md:px-12">
                ...
                <div className="flex h-full flex-col justify-between rounded-lg border border-gray-200 bg-white p-2.5 shadow-sm sm:p-4">
                  ...
                  <div className="mt-4 flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      disabled={isAdding}
                      className="flex flex-1 items-center justify-center rounded-md bg-[#004A6B] py-2 text-sm font-semibold text-white transition-colors hover:bg-[#003852] disabled:cursor-not-allowed disabled:opacity-50 sm:text-base"
                    >
                      <ShoppingCart className="mr-1 h-4 w-4 sm:h-5 sm:w-5" />

                      {isAdding ? "Adding..." : "Add To Cart"}
                    </button>

                    {/* Quantity */}
                    <div className="flex shrink-0 items-center gap-2 rounded-xl border border-gray-300 px-2.5 py-2 sm:gap-4 sm:px-4">
                      <button
                        type="button"
                        onClick={() => {
                          if (currentQty <= 1) {
                      ...
                      <span className="min-w-5 text-center text-base font-semibold text-gray-900 sm:min-w-6 sm:text-lg">
                        {currentQty}
                      </span>
                      ...
                      <button
                        ...
                        className="text-lg font-medium text-gray-500 hover:text-black sm:text-xl"
        ...
        {/* Navigation Arrows */}
        <CarouselPrevious className="left-1 z-10 bg-white/80 backdrop-blur-sm sm:-left-6 md:-left-12" />

        <CarouselNext className="right-1 z-10 bg-white/80 backdrop-blur-sm sm:-right-6 md:-right-12" />
      </Carousel>
    </div>
  );
}
