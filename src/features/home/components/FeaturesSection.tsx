...
const FeaturesSection = () => {
  return (
    <section className="w-full border-b border-gray-200">
      <div className="container mx-auto mr-20 px-4 py-6 sm:py-8 md:py-10">
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div className="flex flex-col gap-0.5 sm:gap-1">
                <h3 className="text-base font-bold text-app-linera sm:text-[17px] md:text-lg">
                  {feature.title}
                </h3>
                <p className="text-sm text-gray-400  leading-snug sm:text-[15px] md:text-base">
                  {feature.description}
                </p>
              </div>
            </div>
